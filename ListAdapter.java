...
public class ListAdapter extends ArrayAdapter<Profile> {
    ...
    public ListAdapter(Context context, int resource, ArrayList<Profile> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int defaultImage = mContext.getResources().getIdentifier("@drawable/stockavatar",null,mContext.getPackageName());
